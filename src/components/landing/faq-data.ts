export const faqs = [
  ...
  },
  {
    ...
    answer:
      "The Free plan includes 3 script generations per month with no credit card required. Usage resets on the 1st of every month. The Creator plan gives you 30 scripts/month at ₹799/mo, and the Pro plan gives you unlimited scripts at ₹1,499/mo.",
  },
  {
