    ...
    <div className="min-h-screen bg-[#060810] text-white overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1] mb-5">
                <span className="block overflow-hidden pb-1">
                  <span className="block" style={{ animation: "reveal-up 0.9s cubic-bezier(0.16,1,0.3,1) 0.15s both" }}>
                    From Idea to
                  </span>
                </span>
                <span className="block overflow-hidden pb-1">
                  <span className="block" style={{ animation: "reveal-up 0.9s cubic-bezier(0.16,1,0.3,1) 0.35s both" }}>
                    <span style={{
                ...
                <span className="block overflow-hidden pb-1">
                  <span className="block text-white/90" style={{ animation: "reveal-up 0.9s cubic-bezier(0.16,1,0.3,1) 0.55s both" }}>
                    in 10 Seconds
                  </span>
                </span>
              </h1>

              <p className="text-lg text-zinc-400 mb-8 leading-relaxed max-w-lg" style={{ animation: "reveal-up 0.8s cubic-bezier(0.16,1,0.3,1) 0.75s both" }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-8" style={{ animation: "reveal-up 0.8s cubic-bezier(0.16,1,0.3,1) 0.9s both" }}>
                <Link
                  href="/signup"
              ...
              <div className="flex items-center gap-5 text-sm text-zinc-500 flex-wrap" style={{ animation: "reveal-up 0.7s cubic-bezier(0.16,1,0.3,1) 1.05s both" }}>
            ...
            <div className="relative" style={{ animation: "reveal-up 1s cubic-bezier(0.16,1,0.3,1) 0.6s both" }}>
      ...
      <section id="workflow" className="py-24 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-6xl mx-auto">
          <AnimateOnScroll className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">5-step production flow</h2>
        ...
        <div className="max-w-4xl mx-auto">
          <AnimateOnScroll>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
              {[
                { icon: Clock, stat: "< 10s", label: "Average script generation time", sub: "From concept to full scene breakdown" },
                { icon: Layers, stat: "6", label: "AI video tools supported", sub: "VEO 3, Kling, Runway, Pika, Midjourney + Generic" },
                { icon: TrendingUp, stat: "90 → 2", label: "Minutes of planning time", sub: "The same work, 45× faster" },
                ...
                <AnimateOnScroll key={i} delay={i * 100}>
                  <div className="rounded-2xl border border-white/[0.07] bg-white/[0.03] p-8 group hover:border-[#00e5c0]/30 hover:bg-[#00e5c0]/[0.03] transition-all duration-300">
                    ...
                    <div className="text-4xl sm:text-5xl font-bold mb-2 tabular-nums" style={{
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={pain} className="flex items-start gap-3">
                      <span className="text-xs font-mono text-red-500 bg-red-500/10 rounded px-2 py-0.5 shrink-0 mt-0.5">{time}</span>
                      <span className="text-sm text-zinc-400">{pain}</span>
                    </li>
                  ))}
                  <li className="flex items-start gap-3 pt-2 border-t border-red-500/15">
                    <span className="text-xs font-mono font-bold text-red-400 bg-red-500/10 rounded px-2 py-0.5 shrink-0 mt-0.5">90 min</span>
            ...
            <AnimateOnScroll delay={120}>
              <div className="rounded-2xl border border-[#00e5c0]/25 bg-[#00e5c0]/[0.05] p-7 h-full" style={{ boxShadow: "0 0 40px -15px rgba(0,229,192,0.3)" }}>
                <div className="flex items-center gap-2 mb-6">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={win} className="flex items-start gap-3">
                      <span className="text-xs font-mono text-[#00e5c0] bg-[#00e5c0]/10 rounded px-2 py-0.5 shrink-0 mt-0.5">{time}</span>
                      <span className="text-sm text-zinc-300">{win}</span>
                    </li>
                  ))}
                  <li className="flex items-start gap-3 pt-2 border-t border-[#00e5c0]/15">
                    <span className="text-xs font-mono font-bold text-[#00e5c0] bg-[#00e5c0]/10 rounded px-2 py-0.5 shrink-0 mt-0.5">&lt; 2 min</span>
      ...
      <section id="demo" className="py-24 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-6xl mx-auto">
          <AnimateOnScroll className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">See what a real script looks like</h2>
            <p className="text-zinc-400 text-lg max-w-xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto">
          <AnimateOnScroll className="text-center mb-10">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
              {tools.map((tool) => (
                <div key={tool.name} className={cn("rounded-xl border p-4 text-center transition-all duration-300 hover:scale-[1.04] hover:-translate-y-1", tool.border, tool.bg)}>
          ...
          <AnimateOnScroll delay={80}>
            <div className="rounded-2xl border border-white/[0.07] bg-white/[0.025] overflow-hidden mt-8">
              <div className="border-b border-white/[0.07] px-5 py-3.5 bg-white/[0.02]">
                <p className="text-xs font-medium text-zinc-400">Same scene — ScriptFlow formats it correctly for each tool automatically</p>
              </div>
      ...
      <section className="py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <AnimateOnScroll className="relative max-w-3xl mx-auto text-center">
          ...
          <p className="text-xs text-zinc-600 mt-6">3 free scripts/month · No credit card required · Cancel anytime</p>
        </AnimateOnScroll>
      </section>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        name: "ScriptFlow AI", url: BASE_URL, logo: `${BASE_URL}/icon-512.png`,
        contactPoint: { "@type": "ContactPoint", email: "parthbrahmkshatriya@gmail.com", contactType: "customer support", availableLanguage: ["English", "Hindi"], areaServed: ["IN", "US", "GB", "AU", "CA"] },
      }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      <footer className="relative py-12 px-4 sm:px-6 lg:px-8 bg-[#040508]">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 pt-8 border-t border-white/[0.05] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-600">
            ...
            <p className="text-zinc-500 hover:text-zinc-300 transition-colors" style={{ textShadow: "0 0 20px rgba(0,229,192,0.4)" }}>
