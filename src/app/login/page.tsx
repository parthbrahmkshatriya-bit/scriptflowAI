...
function LoginForm() {
  ...
  async function handleGoogleLogin() {
    ...
    // On success the browser redirects — keep spinner showing until navigation
  }
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 gap-6 bg-[#050508]">
      ...
      <Card className="w-full max-w-md border-white/10 bg-white/[0.04]">
        ...
        <CardContent className="space-y-4">
          <Button
            variant="outline"
            className="w-full border-white/15 bg-white/5 hover:bg-white/10 hover:border-white/25 text-zinc-300 hover:text-white"
